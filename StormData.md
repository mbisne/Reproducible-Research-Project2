...
```r
  csvStormData <- read.table(file = "C:/Users/i58593/Desktop/Coursera/Course 5/Project/repdata-data-StormData.csv", header = TRUE,sep = ',')
```
...
![](StormData_files/figure-html/unnamed-chunk-14-1.png)
